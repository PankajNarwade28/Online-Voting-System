...
<body>
  <h1>Candidates Information Table</h1>
...
ResultSet rs = stmt.executeQuery("SELECT * FROM CANDIDATE_TABLE");
%>
<table border="1">
<tr><th>ID</th><th>Name</th><th>Party Name</th><th>Gender</th><th>Age</th></tr>
<%
while(rs.next()) {
%>
<tr>
